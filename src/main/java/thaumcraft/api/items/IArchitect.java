...
public interface IArchitect {
     ...
     */
    HitResult getArchitectMOP(ItemStack stack, Level world, LivingEntity player);
    ...
    /**
     * Returns a list of blocks that should be highlighted in world. The starting point is
     * whichever block the player currently has highlighted in the world.
     */
    ArrayList<BlockPos> getArchitectBlocks(ItemStack stack, Level world,
