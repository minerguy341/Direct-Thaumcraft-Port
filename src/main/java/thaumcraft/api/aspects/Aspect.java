...
public class Aspect {
     ...
     * @param blend GL blend mode (1 or 771). Used for rendering nodes. Default is 1
     */
    ...
    public Aspect(String tag, int color, Aspect[] components) {
        this(tag, color, components,
                ResourceLocation.fromNamespaceAndPath("thaumcraft", "textures/aspects/" + tag.toLowerCase() + ".png"), 1);
    }
    ...
    public Aspect(String tag, int color, Aspect[] components, int blend) {
        this(tag, color, components,
                ResourceLocation.fromNamespaceAndPath("thaumcraft", "textures/aspects/" + tag.toLowerCase() + ".png"), blend);
    }
    ...
    /**
     * The latin display name (the capitalized tag).
     */
