 ...
 * @author Azanor
 *
 * Block entities or blocks that extend this interface can have jar labels applied to them
 */
public interface ILabelable {

    /**
     * This method is used by the block or block entity to do whatever needs doing.
